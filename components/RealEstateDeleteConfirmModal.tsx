...
import { deleteRealEstateAsset } from "@/lib/actions/real-estate";
...
export function RealEstateDeleteConfirmModal({ asset, onClose }: Props) {
  ...
  const value = Number.parseFloat(asset.valueEur);
    ...
    >
      ...
      >
        ...
        <p className="mt-2 text-sm text-zinc-400">
          ...
          <span className="font-medium text-zinc-200">{asset.label}</span> (
          {formatEur(value)}) from your real estate holdings.
        </p>
